...
const SliderConfig = ({ onDataChange, initialData }) => {
  ...
  return (
    <div className="p-6 bg-[#FFF5EE]">
      <Formik
        initialValues={{ images: initialData?.images || [] }}
          ...
          return (
            <Form>
              ...
              >
                ...
                <p className="text-gray-600">Drag & drop images or click to select (Min. 3 images)</p>
                <input
                  type="file"
                  accept="image/*"
                  multiple
              ...
              {/* Error Message */}
              {touched.images && errors.images && <div className="text-red-500 text-sm mb-4">{errors.images}</div>}
