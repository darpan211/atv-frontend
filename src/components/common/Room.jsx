  ...
  return (
    <div className="w-full px-4 md:px-10 py-10 text-center">
      ...
      <div className="relative min-h-[500px]">
        ...
        {/* Image Grid */}
        <div
          className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 md:gap-6 justify-center transition-opacity duration-300"
        ...
        >
          {currentImages.map((img, idx) => (
            ...
            >
              ...
              {/* Blue-Black Overlay */}
              <div className="absolute inset-0 bg-[#000d33]/60 opacity-0 group-hover:opacity-100 transition-all duration-700 flex items-center justify-center">
                {/* Glowing Decorative Frame */}
                <div className="absolute w-28 h-28 border-2 border-white rounded-md opacity-0 group-hover:opacity-100 transform scale-50 group-hover:scale-100 transition-all duration-700 animate-pulse shadow-[0_0_15px_rgba(255,255,255,0.5)]" />

                {/* Animated Text */}
                <div className="absolute text-white text-xl md:text-2xl font-semibold tracking-wide opacity-0 translate-y-6 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-700 ease-in-out">
                  Try with visualizer
                </div>
              </div>
            </div>
