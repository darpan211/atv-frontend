...
export const CATEGORIES = [
  { name: 'Living Room', count: 8, icon: '🏠' },
  { name: 'Kitchen', count: 5, icon: '🍳' },
  { name: 'Bathroom', count: 6, icon: '🚿' },
  { name: 'Outdoor', count: 7, icon: '🏞️' },
  { name: 'Bedroom', count: 6, icon: '🛏️' },
  { name: 'Commercial', count: 8, icon: '🏢' },
  { name: 'Counter Tops', count: 6, icon: '🧱' },
  { name: 'Elevation', count: 7, icon: '🏗️' },
];
